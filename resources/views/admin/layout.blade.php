			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										{!! Html::image('back/assets/admin/layout3/img/avatar2.jpg',null,['class'=>'img-circle']) !!}
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										{!! Html::image('back/assets/admin/layout3/img/avatar3.jpg',null,['class'=>'img-circle']) !!}
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										{!! Html::image('back/assets/admin/layout3/img/avatar1.jpg',null,['class'=>'img-circle']) !!}
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						{!! Html::image('back/assets/admin/layout2/img/avatar3_small.jpg',null,['class'=>'img-circle']) !!}
		...
		<div class="page-sidebar-wrapper">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu  page-sidebar-menu-compact" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					<li class="start {{Request::is('admin/about*') ? 'active' : ''}}">
						<a href="{!!Url('/')!!}/admin/about">
						<i class="fa fa-life-saver"></i>
						<span class="title">معلومات عنا</span>
						</a>
					</li>
